...
- Pillar 3 — KI-getriebenes Arbeiten:
  - DE: "KI ist für mich kein Buzzword, sondern Arbeitsweise. Mit Claude Code, GitHub Copilot und Compound Engineering komme ich schneller von der Idee zum produktiven System. Ich bringe diese Arbeitsweise ins Team und sorge dafür, dass KI nicht nur als Tool, sondern als Hebel für bessere Software wirkt."
  - EN: "AI isn&apos;t a buzzword for me, it&apos;s a way of working. With Claude Code, GitHub Copilot, and Compound Engineering, I get from idea to production faster. I bring that way of working into the team and make sure AI acts not just as a tool but as a lever for better software."
